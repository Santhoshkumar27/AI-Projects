...
cap = cv2.VideoCapture('/home/lw-6/vehical/vehicle-detection-classification-opencv/bridge.mp4')
input_size = 320
...
## Model Files
modelConfiguration = '/home/lw-6/vehical/vehicle-detection-classification-opencv/yolov3-320.cfg'
modelWeigheights = '/home/lw-6/vehical/vehicle-detection-classification-opencv/yolov3-320.weights'
...
def realTime():
    while True:
        try:
            ...
            dt = datetime.now()
            print("count --> ",up_list,"date and time ->",dt)
